$(document).ready(function () {
            ...
            var loadPages = function (callback) {
                $('#o_nas').load('cardiocare-o-nas.html');
                $('#badania_kierowcow').load('badania-kierowcow-krakow.html');
                $('#pozwolenie_na_bron').load('badania-na-bron-krakow.html');
                $('#badania-intro').load('dzialalnosc-badawczo-rozwojowa-intro.html');
                $('#kontakt').load('cardiocare-kontakt-krakow.html');
            ...
            $('header, #content').on('click', 'a', function (e) {
                ...
                if (podstrona === 'dzialalnosc-badawczo-rozwojowa.html') {
